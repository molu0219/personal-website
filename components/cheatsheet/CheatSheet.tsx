...
const CARDS: Card[] = [
  {
    ...
    sections: [
      { title: 'General Controls', rows: [
        { key: 'Ctrl+C', val: 'Cancel input or generation' },
        { key: 'Ctrl+D', val: 'Exit session' },
        { key: 'Ctrl+F', val: 'Kill all background agents (2x)' },
        { key: 'Ctrl+G', val: 'Open in text editor' },
        { key: 'Ctrl+L', val: 'Clear terminal screen' },
        { key: 'Ctrl+O', val: 'Toggle verbose output' },
        { key: 'Ctrl+R', val: 'Reverse search history' },
        { key: 'Ctrl+B', val: 'Background running tasks' },
        { key: 'Ctrl+T', val: 'Toggle task list' },
        { key: 'Esc Esc', val: 'Rewind / summarize' },
        { key: 'Shift+Tab', val: 'Cycle permission modes' },
      ]},
      { title: 'Model & Thinking', rows: [
        { key: 'Option+P', keyMac: 'Option+P', keyWin: 'Alt+P', val: 'Switch model' },
        { key: 'Option+T', keyMac: 'Option+T', keyWin: 'Alt+T', val: 'Toggle extended thinking' },
        { key: 'Option+M', keyMac: 'Option+M', keyWin: 'Alt+M', val: 'Cycle permission modes (alt)' },
      ]},
      { title: 'Multiline Input', rows: [
        { key: '\\ + Enter', val: 'Quick escape newline' },
        { key: 'Option+Enter', keyMac: 'Option+Enter', keyWin: 'Alt+Enter', val: 'New line (macOS default)' },
        { key: 'Shift+Enter', val: 'New line (iTerm2/WezTerm/Ghostty/Kitty)' },
        { key: 'Ctrl+J', val: 'New line (control sequence)' },
      ]},
      { title: 'Text Editing', rows: [
        { key: 'Ctrl+K', val: 'Delete to end of line' },
        { key: 'Ctrl+U', val: 'Delete entire line' },
        { key: 'Ctrl+Y', val: 'Paste deleted text' },
        { key: 'Option+B', keyMac: 'Option+B', keyWin: 'Alt+B', val: 'Move cursor back one word' },
        { key: 'Option+F', keyMac: 'Option+F', keyWin: 'Alt+F', val: 'Move cursor forward one word' },
      ]},
      { title: 'Clipboard & Images', rows: [
        { key: 'Cmd+V', keyMac: 'Cmd+V', keyWin: 'Ctrl+V', val: 'Paste image from clipboard' },
      ]},
